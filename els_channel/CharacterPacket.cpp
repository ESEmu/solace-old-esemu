...
namespace els {
	...
	namespace CharacterPacket {
		...
		PacketBuilder playerDataAck(Player* player) { // 0x2A
			std::cout << "Processing 0x2A 0" << std::endl;
			PacketBuilder pb;
			pb
				.writeInt(0)
				.writeInt(0)
				...
				std::cout << "Processing 0x2A 1" << std::endl;
				/*
			...
			pb.writeInt(0); //first 4 bytes of 562 above
				...
				std::cout << "Processing 0x2A 2" << std::endl;
			...
			std::cout << "Processing 0x2A 3" << std::endl;
			// skill slots
			for (int i = 0; i < 8; i++) {
			...
			std::cout << "Processing 0x2A 4" << std::endl;
			pb
				.writeInt(0)
				.writeInt(0)
				.writeByte(1)
			...
			std::cout << "Processing 0x2A 5" << std::endl;
			...
			pb
				...
				// similar to 0x31.
				std::cout << "Processing 0x2A 6" << std::endl;
				for (int i = 0; i < player->getInv()->getMaxSlots(9); i++) {
					int uid = (*player->getInv()->getInventory(9))[i];
					if (uid == -1) continue;
					else {
				...
				std::cout << "Processing 0x2A 7" << std::endl;
				pb
				...
				pb	
					...
					.writeShort(0);
				std::cout << "Processing 0x2A 8" << std::endl;
